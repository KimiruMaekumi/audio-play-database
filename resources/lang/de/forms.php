...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | The following string conversions are used in form labels, buttons and other
    | input element text values. Edit the right side of the lines,
    | and replace the strings with german translations of the strings.
    |
    */
